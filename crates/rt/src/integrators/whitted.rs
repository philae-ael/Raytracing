...
impl Integrator for WhittedIntegrator {
    fn ray_cast(&self, ctx: &mut Ctx, ray: Ray, depth: u32) -> RayResult {
        ...
        let IntersectionResult::Intersection(intersection) =
        ...
        let MaterialDescriptor { ref material, .. } =
            ctx.world.materials[intersection.local_info.material.0];
        ...
        let (albedo, diffuse) = 'diffuse: {
            ...
            for light_pos in ctx.world.lights.iter() {
        ...
        let transmission = 'transmission: {
            ...
            let refracted_ray_result = self.ray_cast(ctx, refracted_ray, depth + 1);
        ...
        let reflection = 'reflection: {
            ...
            let reflected_ray_result = self.ray_cast(ctx, reflected_ray, depth + 1);
